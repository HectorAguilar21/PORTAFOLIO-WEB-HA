  ...
  return (
    <div className="rounded-3xl bg-zinc-200 relative shadow-2xl shadow-black row-span-2">
      <div className="absolute left-1/2 transform -translate-x-1/2 sTMINI:-top-10 sMINI:-top-6">
        <h1 className="title-stack text-center font-bold  text-indigo-800 bg-zinc-200 rounded-3xl sCS:py-3 sCS:px-5 sMINI:py-2 sMINI:px-2 sT:text-5xl sTMINI:text-3xl sMINI:text-xl">
          Front-end
        </h1>
      </div>
      <div className="w-full h-full flex justify-evenly items-center flex-wrap gap-y-5 sTMINI:pt-14 sTMINI:pb-20 sMINI:pt-7 sMINI:pb-14">
